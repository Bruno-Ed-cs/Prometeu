...
<html leng="pt-br">
   ...
   <body>
      ...
      <div class="container">
         ...
         <h2>Introdução</h2>
         <a href='artigo_zumbi_filosofico_1.html' class="showcase">
            <div class="show-header">
               <h4>O Apocalipse Zumbi (Filosófico!) – Parte 1</h4>
            </div>
            <div class="show-body">
               <div class="display"><img src = I1/Shaun.jpg></div>
               <p>
         ...
         <a href='artigo_zumbi_filosofico_2.html' class="showcase">
            <div class="show-header">
               <h4>O Apocalipse Zumbi (Filosófico!) – Parte 2</h4>
            </div>
            <div class="show-body">
               <div class="display"><img src = I1/I_Am_a_Hero.jpg></div>
               <p>
         ...
         <a href='Artigos/artigo_qualia.php' class="showcase">
            ...
            <div class="show-body">
               <div class="display"><img src = I1/Kate_Bush.jpeg></div>
               <p>
         ...
         <a href='artigo_epifenomenalismo.html' class="showcase">
            <div class="show-header">
               <h4>Roubou as cores do universo? Melhor ligar pro Saul. (qualia epifenomenal vs fisicalismo)</h4>
            </div>
            <div class="show-body">
               <div class="display"><img src = I1/Saul_Goodman.jpeg></div>
               <p>
